  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Main CTA Surface */}
        <div 
          className={`rounded-2xl sm:rounded-3xl bg-[#041628] text-white p-6 sm:p-10 lg:p-12 relative overflow-hidden shadow-2xl border-2 border-teal-500/20 transition-all duration-700 ease-out ${
        ...
        >
          ...
          <div className="relative z-10">
            <div className="max-w-3xl">
              ...
              <h2 className="text-2xl sm:text-4xl lg:text-5xl font-extrabold tracking-tight leading-tight text-white mb-3 sm:mb-4">
                Ready to take the next step?
              </h2>

              <p className="text-base sm:text-lg text-slate-200 leading-relaxed font-normal mb-6 sm:mb-7 max-w-2xl">
            ...
            <div className="pt-6 sm:pt-7 border-t border-white/15 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 w-full">
              <div>
                <span className="flex items-center gap-2 text-slate-300 uppercase tracking-wider text-xs font-bold mb-1.5">
                  <Phone className="w-3.5 h-3.5 text-teal-400" />
                  <span>Phone Inquiries</span>
                </span>
                <a 
                  href={CLINIC_INFO.phoneTel} 
                  className="text-base sm:text-lg font-bold text-white block mt-1 hover:text-teal-300 transition-colors"
                >
              ...
              <div>
                ...
                <span className="text-sm font-semibold text-white block mt-1 leading-relaxed">
                  {CLINIC_INFO.address}
                </span>
              </div>
