      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <div className="relative max-w-3xl z-10">
            ...
            <div className="pt-8 border-t border-white/15 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
              <div>
                ...
                <span className="text-xs sm:text-sm font-semibold text-white font-mono block mt-1">{CLINIC_INFO.placeholders.phone}</span>
              </div>
              ...
              <div>
                ...
                <span className="text-xs sm:text-sm font-semibold text-white font-mono block mt-1">{CLINIC_INFO.placeholders.address}</span>
              </div>
