      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="min-w-0">
            ...
            <div className="max-w-3xl mb-7 sm:mb-9">
              ...
              <h2 
                className={`text-3xl sm:text-4xl lg:text-5xl font-extrabold text-white tracking-tight leading-[1.15] sm:leading-[1.12] mb-5 transition-all ${
                  isActive 
              ...
              <div 
                className={`space-y-4 text-base sm:text-lg text-slate-200 leading-relaxed font-normal transition-all ${
                  isActive 
            ...
            <div className="mb-8 sm:mb-10">
              <span 
                className={`text-xs font-bold tracking-wider text-teal-300 uppercase block mb-5 transition-all ${
                  isActive 
              ...
              <p className="text-xs text-slate-300 mt-5 italic">
            ...
            <div 
              className={`grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center bg-navy-900/90 rounded-2xl sm:rounded-3xl p-6 sm:p-8 lg:p-9 border border-white/15 shadow-elevated relative overflow-hidden transition-all ${
                isActive 
            ...
            >
              <div className="lg:col-span-7 flex flex-col items-start space-y-4 sm:space-y-5">
                <span className="text-xs font-bold tracking-wider text-teal-300 uppercase block">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 w-full pt-1">
                  <div className="flex items-center gap-3 bg-white/[0.06] border border-white/10 rounded-xl p-3.5">
                    ...
                    <span className="text-xs sm:text-sm text-slate-100 font-medium">Supervised progressive sessions</span>
                  </div>
                  <div className="flex items-center gap-3 bg-white/[0.06] border border-white/10 rounded-xl p-3.5">
                    <span className="w-5 h-5 rounded-full bg-teal-500/20 border border-teal-400/40 flex items-center justify-center text-teal-300 shrink-0">
                      <Check className="w-3.5 h-3.5 stroke-[2.5]" />
                    </span>
                    <span className="text-xs sm:text-sm text-slate-100 font-medium">Return to everyday movement</span>
                  </div>
                </div>
              ...
              <div className="lg:col-span-5">
                ...
                <p className="text-xs text-slate-300 mt-2.5 font-medium text-center sm:text-left">
